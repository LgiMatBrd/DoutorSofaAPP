    ...
    <md-card-content class="md-padding">
      ...
      <div layout-gt-md="row" layout="column" layout-align-gt-md="center center">
        <md-input-container flex-gt-md="30">
          ...
          <input mdc-datetime-picker date="false" time="true" seconds="true" type="text" id="time3" short-time="false"
      ...
      <div layout-gt-md="row" layout="column" layout-align-gt-md="center center">
        <md-input-container flex-gt-md="25">
          ...
          <input mdc-datetime-picker date="true" time="true" type="text" id="datetimeedit"
                 placeholder="Date" show-todays-date minutes="true"
                 min-date="date" edit-input="true"
                 ng-model="dateTimeEdit">
        </md-input-container>
        <div flex-gt-md="5">
          <md-button class="md-primary md-icon-button" style="top:-12px;left:-12px;" ng-click="displayDialogEdit()">
